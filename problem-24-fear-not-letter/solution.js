 ...
 * Fear Not Letter
 * 
 * Finds the missing letter in a consecutive sequence of letters.
 * If all letters are present, returns undefined.
 */
...
function fearNotLetter(str) {
    ...
    // All letters are in order - no missing letter
    return undefined;
}
...
console.log(fearNotLetter("abcdefg"));     // undefined
